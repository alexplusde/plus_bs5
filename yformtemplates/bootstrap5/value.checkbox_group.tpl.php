...
<div class="form-check-group form-group mb-4">
    ...
    <?php foreach ($options as $k => $v): ?>
        ...
        <div class="<?= $class_group ?> mb-3">
            <input class="form-check-input" type="checkbox" name="<?= $this->getFieldName() ?>[]"
                   value="<?= $k ?>"<?= in_array($k, $this->getValue()) ? ' checked="checked"' : '' ?> />
