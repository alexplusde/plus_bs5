...
$field->setLabel(rex_i18n::msg('plus_bs5_header'));

$field = $form->addSelectField('nav_depth');
$field->setLabel($this->i18n('plus_bs5_nav_depth_label'));
$select = $field->getSelect();
$select->setSize(1);
$select->addOption($this->i18n('plus_bs5_nav_depth_1'), '1');
$select->addOption($this->i18n('plus_bs5_nav_depth_2'), '2');
