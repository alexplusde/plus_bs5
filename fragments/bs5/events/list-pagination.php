...
<nav aria-label="Seite wählen">
	<ul class="pagination justify-content-center">
		...
		<li class="page-item">
			<a class="page-link"
				href="<?= rex_getUrl(null, null, ['page' => rex_get('page', 'int', 1) - 1]) ?>">
				&lt;&lt;</a>
		</li>
		<?php
        } else {
...
foreach (range(1, ceil($total / $limit)) as $page) {
    ?>
		<li
			class="page-item <?= rex_get('page', 'int', 1) === $page ? 'active' : '' ?>">
			<a class="page-link"
				href="<?= rex_getUrl(null, null, ['page' => $page]) ?>"><?= $page ?></a>
		</li>
		<?php
}
...
if ($offset + $limit < $total) {
    ?>
		<li class="page-item">
			<a class="page-link"
				href="<?= rex_getUrl(null, null, ['page' => rex_get('page', 'int', 1) + 1]) ?>">Next</a>
		</li>
		<?php
} else {
    ?>
